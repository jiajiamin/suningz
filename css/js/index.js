window.onload=function(){
	...
	function move(){
		num++;
		// if (num==0){bigbox.style.background="#0103A6";}
		if (num==1){bigbox.style.background="#FED5DC";}
		if (num==2){bigbox.style.background="#FFEBF4";}
		if (num==3){bigbox.style.background="#F6E8E5";}
		if (num==4){bigbox.style.background="#C3EEF7";}
		if (num==5){bigbox.style.background="#7EB2FC";}
		if (num==6){bigbox.style.background="#EDC3CD";}
		if (num==7){bigbox.style.background="#FED1D8";}
	...
	for (let i=0;i<btn.length;i++){
		btn[i].onclick=function(){
			if (i==0){bigbox.style.background="#0103A6";}
			if (i==1){bigbox.style.background="#FED5DC";}
			if (i==2){bigbox.style.background="#FFEBF4";}
			if (i==3){bigbox.style.background="#F6E8E5";}
			if (i==4){bigbox.style.background="#C3EEF7";}
			if (i==5){bigbox.style.background="#7EB2FC";}
			if (i==6){bigbox.style.background="#EDC3CD";}
			if (i==7){bigbox.style.background="#FED1D8";}
	...
	nav1.forEach(function(v,i){
		...
		v.onmouseenter=function(){
			...
			cons2.style.heigth="122px";
		}
		v.onmouseleave=function(){
			// v.style.overflow="hidden";
			cons2.style.heigth="0";
		}
	})
